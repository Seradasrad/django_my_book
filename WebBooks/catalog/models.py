...
class Genre(models.Model):
    ...
    # Методы
    def __str__(self):
        # Строка для представления объекта Genre в Admin site
        return self.name
...
class Author(models.Model):
    first_name = models.CharField(max_length=200, help_text='Введите имя автора',
                                  verbose_name='Имя автора')
    last_name = models.CharField(max_length=200, help_text='Введите фамилию автора автора',
...
class Book(models.Model):
    title = models.CharField(max_length=200, help_text="Введите нвзвание книги",
    ...
    summary = models.TextField(max_length=1000, help_text='Введите краткое опсиание книги',
...
class BookInstance(models.Model):
    ...
    status = models.ForeignKey('Status', on_delete=models.CASCADE,
                               ...
                               verbose_name='Статус экземпляра книги')
    due_back = models.DateField(null=True, blank=True, help_text='Введите конце срока статуса',
